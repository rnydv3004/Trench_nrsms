    ...
    return (
        <div className='flex justify-center items-center gap-2 text-white h-10 p-1'>
            ...
            <Tooltip title={"Messages"}>
                <ChatIcon className="border-2 border-slate-300 rounded-lg h-full w-fit p-1" onClick={() => {  }} />
            </Tooltip>
            <Tooltip title={"Log out"}>
                <LogoutIcon className="border-2 border-slate-300 rounded-lg h-full w-fit p-1" onClick={() => {}} />
            </Tooltip>
        </div>
    )
}
